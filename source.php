...
<td width="20%"></td>
<td width="50%">
<table class="scrollbar" width="100%" height="100%" cellpading="0" cellspacing="0" border="1" bordercolor="white">
<thead>
<tr>
<th width="30%">
Release Date
...
$qry = "SELECT * FROM tb_source_code ORDER BY source_release_date DESC";
$sql = mysql_query($qry);
...
<td width=20.5%>
<a href=source_download.php?id=$id target=_blank>Download</a>
</td>
<td width=17.5%>
$hit
</td>
